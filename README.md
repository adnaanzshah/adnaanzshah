...
<h1><code>> /sys/init/adnaan_shah.sh</code></h1>

<br>

<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=24&pause=1000&color=00FFCC&center=true&vCenter=true&width=800&lines=AI+Engineer+%7C+Data+Scientist;Engineering+Scalable+Data+Systems;Architecting+Autonomous+Intelligence;Deploying+High-Performance+Models" alt="Typing SVG" />
</a>

<p align="center">
  <i>Designing robust, high-performance machine learning workflows that bridge the gap between theoretical data science and applied software engineering.</i>
</p>
...
### `> cat /usr/local/bin/executive_summary.txt`
...
### `> ls -la /opt/neural_networks/dependencies/`

<div align="center">
  <br>
  <img src="https://skillicons.dev/icons?i=python,tensorflow,sklearn,pytorch,arch,linux&theme=dark" alt="Tech Stack" />
  <br>
</div>

<br>

### `> grep "deploy" /var/log/experience.log`
...
### `> establish_secure_connection --target adnaanzshah`
